...
% Computes the 0-th (the number of connected components) and 1st Betti numbers 
% (cycles) and the size of the largest cycle over the range of filtration 
% values in the 1-skeleton of connectivity matrix C

% C           : Weighted c]onnectivity matrix or edge weights
...
%
% Additional references related to the Exact Topologica Inference over beta0 and beta1. 
%
